...
<title>Class Hymns | Asbury Hymn Project</title>
</head>

<body id="page-classhymns">

    <?php include '../components/navbar.php'; ?>

    <div id="header" class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Class Hymns</h1>
        </div>
    </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td>2022</td>
                                        <td>Faithful</td>
                                        <td><a href="/hymn-texts/text?number=15">Great Is Thy Faithfulness</a></td>
                                    </tr>
                                    <tr>
                                        <td>2021</td>
                                        <td>Appointed</td>
                                        <td><a href="/hymn-texts/text?number=25">It Is Well With My Soul</a></td>
                                    </tr>
                                    <tr>
                                        <td>2020</td>
                                        <td>Visionary</td>
                                        <td><a href="/hymn-texts/text?number=8">Be Thou My Vision</a></td>
                                    </tr>
                                    <tr>
                                        <td>2019</td>
                                        <td>Merciful</td>
                                        <td><a href="/hymn-texts/text?number=26">Jesus Paid It All</a></td>
                                    </tr>
                                    <tr>
                                        <td>2018</td>
                                        <td>Vindicated</td>
                                        <td><a href="/hymn-texts/text?number=24">In Christ Alone</a></td>
                                    </tr>
                                    <tr>
                                        <td>2017</td>
                                        <td>Anchored</td>
                                        <td><a href="/hymn-texts/text?number=46">The Solid Rock</a></td>
                                    </tr>
                                    <tr>
                                        <td>2016</td>
                                        <td>Ransomed</td>
                                        <td><a href="/hymn-texts/text?number=19">How Deep the Father's Love</a></td>
                                    </tr>
                                    <tr>
                                        <td>2015</td>
                                        <td>Unshakable</td>
                                    ...
                                    <tr>
                                        <td>2013</td>
                                        <td>Awakened</td>
                                        <td><a href="/hymn-texts/text?number=11">Come Thou Fount</a></td>
                                    </tr>
                                    <tr>
                                        <td>2012</td>
                                        <td>Zealous</td>
                                    ...
                                    <tr>
                                        <td>2009</td>
                                        <td>Consecrated</td>
                                        <td><a href="/hymn-texts/text?number=44">Take My Life and Let It Be Consecrated</a></td>
                                    </tr>
                                    <tr>
                                        <td>2008</td>
                                        <td>Empowered</td>
                                    ...
                                    <tr>
                                        <td>2004</td>
                                        <td>Agape</td>
                                        <td><a href="/hymn-texts/text?number=21">How Great Thou Art</a></td>
                                    </tr>
                                    <tr>
                                        <td>2003</td>
                                        <td>Anointed</td>
                                    ...
                                    <tr>
                                        <td>2001</td>
                                        <td>Redeemed</td>
                                        <td><a href="/hymn-texts/text?number=7">And Can It Be</a></td>
                                    </tr>
                                    <tr>
                                        <td>2000</td>
                                        <td>Pathfinders</td>
                                        <td><a href="/hymn-texts/text?number=48">To God Be the Glory</a> / Shine, Jesus, Shine</td>
                                    </tr>
                                    <tr>
                                        <td>1999</td>
                                        <td>Seekers</td>
                                    ...
                                    <tr>
                                        <td>1995</td>
                                        <td>Guardians</td>
                                        <td><a href="/hymn-texts/text?number=2">A Mighty Fortress Is Our God</a></td>
                                    </tr>
                                    <tr>
                                        <td>1994</td>
                                        <td>Challengers</td>
                                    ...
                                    <tr>
                                        <td>1985</td>
                                        <td>Victors</td>
                                        <td>Faith Is the Victory</td>
                                    </tr>
                                    <tr>
                                        <td>1984</td>
                                        <td>Heralds</td>
                                        <td>Heralds of Christ</td>
                                    </tr>
                                    <tr>
                                        <td>1983</td>
                                        <td>Ambassadors</td>
                                    ...
                                    <tr>
                                        <td>1973</td>
                                        <td>Cavaliers</td>
                                        <td><a href="/hymn-texts/text?number=48">To God Be the Glory</a></td>
                                    </tr>
                                    <tr>
                                        <td>1972</td>
                                        <td>Warriors</td>
