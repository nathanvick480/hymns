            ...
            <div class="col-sm-10">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>The following is an alphabetic list of all hymn tunes in the <i>Asbury Hymn Project's</i> collection. Because this collection is relatively small and specific (there are thousands of hymns in existence), most tunes in this list are not associated with multiple hymns.</p>
